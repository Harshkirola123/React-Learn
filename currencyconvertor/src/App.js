...
function App() {
  ...
  return (
    <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat'
      style={{
        background:`url(https://images.pexels.com/photos/1605325/pexels-photo-1605325.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)`,
      }}
    >
      {/* <img alt="photo" src='https://images.pexels.com/photos/4210786/pexels-photo-4210786.jpeg'  className='w-40 h-100 shadow-black shadow-2xl'/> */}
